                            ...
                            @forelse($opens as $u)
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    ...
                                    <td
                                       ...
                                       <a href="{{route('user.create_appointement',['workshop' => $u->id])}}" class="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 bg-red-100 rounded-full"> Book Now</a>
